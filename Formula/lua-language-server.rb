class LuaLanguageServer < Formula
  ...
  url "https://github.com/sumneko/lua-language-server.git",
    tag:      "2.3.6",
    revision: "ccf476f0459ee983c97bfc06b0f7b888af918a07"
  license "MIT"
  head "https://github.com/sumneko/lua-language-server.git"

  bottle do
    root_url "https://github.com/saadparwaiz1/homebrew-personal/releases/download/lua-language-server-2.3.4"
    sha256 cellar: :any,                 catalina:     "755d6b43406e6cdaa34846cc529bd85714c8d896d478d8062658e1bf1526bbbf"
    sha256 cellar: :any_skip_relocation, x86_64_linux: "ea334e35616059a70e57ca7c144209c864fa03bd8a2e5f07c19b2bb95361bf74"
  end
